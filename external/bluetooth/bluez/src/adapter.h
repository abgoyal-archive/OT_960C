...
#ifdef BT_ALT_STACK
#define DEVICE_TYPE_BREDR   0x01
#define DEVICE_TYPE_BLE     0x02
#define DEVICE_TYPE_DUMO    0x03

#define DEVICE_ADDR_PUBLIC  0x00
#define DEVICE_ADDR_RANDOM  0x01
...
#ifdef     BT_ALT_STACK
	uint8_t dev_type;   //device type - BR-EDR, BLE only, Dual mode
#endif
};
