...
bool RenderBlock::handleRunInChild(RenderBox* child)
{
    ...
    RenderBlock* currBlock = toRenderBlock(curr);
		...
		//Google Security 0004-Cherry-pick-WebKit-change-r100677-to-fix-a-rendering Patch by Jane.Woo 20120312		
    ...
    inlineRunIn->setStyle(blockRunIn->style());
     ...
     //Google Security 0002-Cherry-pick-WebKit-change-r59357-to-fix-a-rendering Patch by Jane.Woo 20120312
    ...
    for (RenderObject* runInChild = blockRunIn->firstChild(); runInChild;) {
       ...
       // }
        ...
        blockRunIn->children()->removeChildNode(blockRunIn, runInChild, false);
        inlineRunIn->addChild(runInChild); // Use addChild instead of appendChildNode since it handles correct placement of the children relative to :after-generated content.        runInChild = nextSibling;
