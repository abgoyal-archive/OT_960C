...
#include <linux/pmic8058-vibrator.h>	//	Teddy 2011-12-28
...
/* BEGIN : Features of vulcan */
//#define DEBUG
#define USES_TCT_USBDRIVER
...
/* Include backlight */
#ifdef CONFIG_FB_MSM_MDDI_RY002Z_WVGA
#define LCD_WEGA_RESET_GPIO 100
#endif /* CONFIG_FB_MSM_MDDI_RY002Z_WVGA */

int gyro_exist = 0;

/* Debugging feature */
//#define VULCAN_LCD_DEBUG

/* END : Features of vulcan */

#if 1	// 20120612 by sinclair.lee for 8GB MuveMusic SDCard
static struct msm_gpio sdc4_cfg_data_gnd[] = {
	{GPIO_CFG(58, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA), "sdc4_clk"},
	{GPIO_CFG(59, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA), "sdc4_cmd"},
	{GPIO_CFG(60, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA), "sdc4_dat_3"},
	{GPIO_CFG(61, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA), "sdc4_dat_2"},
	{GPIO_CFG(62, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA), "sdc4_dat_1"},
	{GPIO_CFG(63, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA), "sdc4_dat_0"},
};
#endif
...
#if 1	// 20120611 by sinclair.lee for 8GB MuveMusic SDCard. issue real power off. set all signal to gnd
		{
			int itemCnt = ARRAY_SIZE(sdc4_cfg_data_gnd);

			gpio_set_value_cansleep(
				PM8058_GPIO_PM_TO_SYS(PMIC_GPIO_SDC4_EN_N), 1);
			msm_gpios_request_enable(sdc4_cfg_data_gnd, itemCnt);
			for(rc=0; rc<itemCnt; rc++)
				gpio_set_value(58+rc, 0);

			msleep(150);	// 20120706 changed by sinclair.lee from 50ms to 150ms

			gpio_set_value_cansleep(
				PM8058_GPIO_PM_TO_SYS(PMIC_GPIO_SDC4_EN_N), 0);
			msm_gpios_disable_free(sdc4_cfg_data_gnd, itemCnt);
			msleep(20);	// 20120706 added by sinclair.lee
		}
#else
		gpio_set_value_cansleep(
			PM8058_GPIO_PM_TO_SYS(PMIC_GPIO_SDC4_EN_N), 0);
...
static const unsigned int vulcan_keymap[] = {
...
static struct matrix_keymap_data vulcan_keymap_data = {
        .keymap_size    = ARRAY_SIZE(vulcan_keymap),
        .keymap         = vulcan_keymap,
};

static struct pmic8058_keypad_data vulcan_keypad_data = {
	.input_name		= "vulcan-keypad",
	.input_phys_device	= "vulcan-keypad/input0",
	.num_rows		= 5, // PM8058_MIN_ROWS == 5
	.num_cols		= 5, // PM8058_MIN_COLS == 5
	.rows_gpio_start	= 8,
	.cols_gpio_start	= 0,
	.debounce_ms		= {8, 10},
	.scan_delay_ms		= 32,
	.row_hold_ns		= 91500,
	.wakeup			= 1,
	.keymap_data            = &vulcan_keymap_data,
};
...
static struct pmic8058_led pmic8058_vulcan_leds[] = {
	[0] = {
...
static struct pmic8058_leds_platform_data pm8058_vulcan_leds_data = {
	.num_leds = ARRAY_SIZE(pmic8058_vulcan_leds),
	.leds	= pmic8058_vulcan_leds,
};
...
static uint32_t camera_off_gpio_table[] = {
	...
	#else
	GPIO_CFG(19,  0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), /*AF EN*/
	GPIO_CFG(21,  0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /*MAIN CAM RST*/
// kykim vreg 2	GPIO_CFG(33,  0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /*SUB CAM PDN*/
	GPIO_CFG(99,  0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), /*MAIN CAM CTYPE*/
// kykim vreg 	GPIO_CFG(143,  0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /*MAIN CAM PDN*/
...
// kykim vreg 2	GPIO_CFG(33,  0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /*SUB CAM PDN*/
	GPIO_CFG(99,  0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), /*MAIN CAM CTYPE*/
// kykim vreg	GPIO_CFG(143,  0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /*MAIN CAM PDN*/
...
static int config_camera_on_gpios(void)
{
	...
	gpio_set_value(CAM_STNDBY, 1);  // kykim vreg 
	gpio_set_value(33, 1); 	// kykim vreg 2 
...
#ifdef FIXED_CAMIF_RECOVERY	// kykim tp1 
...
static struct msm_camera_sensor_flash_src msm_flash_src_current_driver = {
	...
	._fsrc.current_driver_src.driver_channel = &pm8058_vulcan_leds_data,
};
...
static struct msm_camera_sensor_info msm_camera_sensor_ov5647_data = {
	...
	.vcm_pwd        = 0,  //GPIO for actuator on/off
	.vcm_enable     = 19,
	.pdata          = &msm_camera_device_data,
	.resource       = msm_camera_resources,
	.num_resources  = ARRAY_SIZE(msm_camera_resources),
	.flash_data     = &flash_ov5647,
	.csi_if         = 1 // 0: Paraleel interface, 1: MIPI interface 
};
...
static uint32_t audio_pamp_gpio_config_two =
   GPIO_CFG(85, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA);		//by Jane.Woo 20111207 
...
static int __init snddev_poweramp_gpio_init(void)
{
	...
	rc = gpio_tlmm_config(audio_pamp_gpio_config_two, GPIO_CFG_ENABLE);		//by Jane.Woo 20111207 
	if (rc) {
		printk(KERN_ERR
...
void msm_snddev_poweramp_on(void)
{
	...
	gpio_set_value(85, 1); 		//by Jane.Woo 20111207
...
void msm_snddev_poweramp_off(void)
{
	...
	gpio_set_value(85, 0); 		//by Jane.Woo 20111207
...
#define TIMPANI_RESET_GPIO	84		//by Jane.woo 20111207
...
#endif
#ifdef CONFIG_USB_ANDROID
#ifdef USES_TCT_USBDRIVER	//	Teddy 2012-02-22
...
#ifdef USES_TCT_USBDRIVER	//	Teddy 2012-02-22
	.vendorID	= 0x1BBB,
	.vendorDescr	= "Alcatel Incorporated",
#else
	.vendorID	= 0x05C6,
...
static struct android_usb_platform_data android_usb_pdata = {
	...
	.product_id	= 0x9017,
	.version	= 0x0100,
	.product_name		= "Alcatel HSUSB Device",
	.manufacturer_name	= "Alcatel Incorporated",
...
static struct kgsl_device_platform_data kgsl_3d0_pdata = {
	.pwr_data = {
		...
		.idle_timeout = HZ/20,
		.nap_allowed = true,
		.idle_needed = true,	// by sinclair.lee 20120424 according to Qualcomm CR328249
	},
	.clk = {
		.name = {
			.clk = "grp_clk",
...
static unsigned wega_reset_gpio =
	GPIO_CFG(LCD_WEGA_RESET_GPIO, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA);

#if 1//LCD RGB Invert Issue
static int sensor_power(int on);
int display_reset_power(unsigned char on)
{
	struct vreg *vreg_ldo20, *vreg_ldo15 = NULL;

	vreg_ldo20 = vreg_get(NULL, "gp13");		
	vreg_ldo15 = vreg_get(NULL, "gp6");
	gpio_tlmm_config(wega_reset_gpio, GPIO_CFG_ENABLE);
	
	if(!on)//off
	{		
		vreg_disable(vreg_ldo20);
		vreg_disable(vreg_ldo15);
		gpio_set_value(LCD_WEGA_RESET_GPIO, 0);
	...
	{
		//sensor_power(1);
		gpio_set_value(LCD_WEGA_RESET_GPIO, 0);   /* bring reset line low to hold reset*/
		//mdelay(5); /* 10 msec before IO can be accessed */
			
		vreg_set_level(vreg_ldo20, 1800);
		vreg_set_level(vreg_ldo15, 2800);		//	Teddy 2012-02-07
	
		vreg_enable(vreg_ldo20);
		//mdelay(5);
		vreg_enable(vreg_ldo15);
		mdelay(5);
	
		gpio_set_value(LCD_WEGA_RESET_GPIO, 1);
...
static int display_vulcan_power(int on)
{
	struct vreg *vreg_ldo20, *vreg_ldo15 = NULL;
	...
	{
		gpio_set_value(LCD_WEGA_RESET_GPIO, 0);   /* bring reset line low to hold reset*/
		mdelay(1); /* 10 msec before IO can be accessed */
		...
		gpio_set_value(LCD_WEGA_RESET_GPIO, 1);
		mdelay(15); /* 10 msec before IO can be accessed */
...
static int display_vulcan_power(int on)
{
	...
	static int power_on_init = 0;
	struct vreg *vreg_ldo20, *vreg_ldo15 = NULL;
	struct vreg *vreg_ldo8, *vreg_ldo10 = NULL;
	struct vreg *vreg_ldo12, *vreg_ldo16 = NULL;
#ifdef VULCAN_LCD_DEBUG
	VULCAN_DEBUG("on = %d\n", on);
#endif

	return 0;	//	Teddy 2012-02-24

	if(!power_on_init && on)
	{
		power_on_init = 1;
		VULCAN_DEBUG("display_vulcan_power = %d\n", on);
	}
	else
	{
		VULCAN_DEBUG("display_vulcan_power return= %d\n", on);
		return 0;
	}
	...
	if (on) {
		/* reset WeGA chip -- toggle reset pin -- gpio_100 */
	...
	if (IS_ERR(vreg_ldo10)) {
		...
		pr_err("%s: gp4 vreg get failed (%d)\n",
			__func__, rc);
		return rc;
	}
	...
	rc = vreg_set_level(vreg_ldo15, 2800);		//	Teddy 2012-02-07
	if (rc) {
	...
	rc = vreg_set_level(vreg_ldo10, 2800);
	if (rc) {
	...
	rc = vreg_set_level(vreg_ldo16, 2800);
	if (rc) {
	...
	if (on) {
		gpio_set_value(LCD_WEGA_RESET_GPIO, 0); /* bring reset line low */
		mdelay(20);
		...
		mdelay(20);		/* ensure power is stable */

		gpio_set_value(LCD_WEGA_RESET_GPIO, 1); /* bring reset line high */
		mdelay(20);	/* 20 msec before IO can be accessed */
		...
		if (rc) {
			pr_err("%s: LDO10 vreg disable failed (%d)\n",
			       __func__, rc);
			return rc;
		}
...
static struct mddi_platform_data mddi_pdata = {
	.mddi_power_save = display_vulcan_power,
...
#endif//#if(0)
//[morris
#if (1)//defined(CONFIG_MSM_BT_POWER) 
static struct platform_device msm_bt_power_device = {
	.name = "bt_power",
};
...
static struct msm_gpio bt_config_power_off[] = {
	{ GPIO_CFG(38, 	0, GPIO_CFG_INPUT,  GPIO_CFG_NO_PULL,   GPIO_CFG_2MA),  "MSM_WAKE_BT" },
	{ GPIO_CFG(40, 	0, GPIO_CFG_INPUT,  GPIO_CFG_NO_PULL,   GPIO_CFG_2MA),  "BT_WAKE_MSM" },
...
#if 0	//	Teddy
	{ GPIO_CFG(138, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN,   GPIO_CFG_2MA),	"PCM_DOUT" 	},
	{ GPIO_CFG(139, 1, GPIO_CFG_INPUT,  GPIO_CFG_PULL_DOWN,   GPIO_CFG_2MA),	"PCM_DIN" 	},
	{ GPIO_CFG(140, 1, GPIO_CFG_INPUT,  GPIO_CFG_PULL_DOWN,   GPIO_CFG_2MA),	"PCM_SYNC" 	},
	{ GPIO_CFG(141, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN,   GPIO_CFG_2MA),	"PCM_CLK" 	},
#endif
};
...
static struct msm_gpio wifi_wake[] = {
	{GPIO_CFG(42,  0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "wifi_wake_bb"},
};
...
static void __init wlan_power_init(void)
{
	...
	msm_gpios_enable(wifi_wake, ARRAY_SIZE(wifi_wake));
...
#ifdef USE_FUEL_GAUGE // Teddy 2012-01-02
...
// kykim camio #ifndef CONFIG_QUP_EXCLUSIVE_TO_CAMERA
...
qup_i2c_gpio_config(int adap_id, int config_type)
{
	...
	/*This needs to be enabled only for OEMS*/
// kykim camio #ifndef CONFIG_QUP_EXCLUSIVE_TO_CAMERA
// Only support Cam pwr on/off on ACG or later HW version 
	if(get_hw_id() < HW_ID_REV_V5A){
		printk(KERN_ERR "Only support PS or before HW version\n");  // kykim log 
	if (qup_vreg) {
...
#if 1	// 20120612 by sinclair.lee vulcan uses eMMC which uses the L5(eMMC) of PM regulator
	if (pdev == (void*)-1) /* never called */
#else
...
int ft_tsp_power( int on )
{
	...
	if (IS_ERR(vreg_ldo13)) {
		rc = PTR_ERR(vreg_ldo13);
		pr_err("%s: wlan vreg get failed (%d)\n",
			__func__, rc);
		return rc;
	}

	rc = vreg_set_level(vreg_ldo13, 2800);
	if (rc) {
		pr_err("%s: vreg LDO13 set level failed (%d)\n",
			__func__, rc);
		return rc;
	}
	...
	if( on )
	{
		...
		if (rc) {
			pr_err("%s: LDO13 vreg enable failed (%d)\n",
				__func__, rc);
			return rc;
		}
	}
	else
	{
		...
		if (rc) {
			pr_err("%s: LDO13 vreg disable failed (%d)\n",
			       __func__, rc);
			return rc;
		}
	}
...
#define GYRO_IRQ		44
#define ACCEL_ADDR		0x08
#define ACCEL_IRQ		51
#define COMPASS_ADDR	0x0c
#define COMPASS_IRQ		180
#define PROX_IRQ		142
...
void msm8x55_gpio_i2c_pin(struct i2c_gpio_platform_data *i2c_adap_pdata,
...
//------------------------------- Gyro sensor --------------------------------------
//------------------------------- gpio based --------------------------------------
static struct mpu3050_platform_data mpu3050_pdata_gpio_i2c = {
	.int_config  = 0x10,
	.orientation = {  1,  0,  0,
			   0,  -1,  0,
			   0,  0, -1 },
...
#endif
		 .irq = MSM_GPIO_TO_INT(COMPASS_IRQ),
		 .adapt_num   = 8,
...
static struct i2c_board_info mpu3050_sensor_i2c_bdinfo_gpio[] = {

		{
			I2C_BOARD_INFO("mpu3050", GYRO_ADDR),
			.irq = MSM_GPIO_TO_INT(GYRO_IRQ),
			.platform_data = &mpu3050_pdata_gpio_i2c,
		},
		{
			I2C_BOARD_INFO("bma222", ACCEL_ADDR),
			.flags = I2C_CLIENT_WAKE,
			.irq = MSM_GPIO_TO_INT(ACCEL_IRQ),
		},
		{
			I2C_BOARD_INFO("ak8975", COMPASS_ADDR),
			.irq = MSM_GPIO_TO_INT(COMPASS_IRQ),
		},
};

static struct gpio_i2c_pin mpu3050_sensor_i2c_pin[] = {
	{
		.scl_pin	= 47,
		.sda_pin	= 48,
		.irq_pin = 44
...
static struct i2c_gpio_platform_data mpu3050_sensor_i2c_pdata = {
	.scl_pin	= 47,
	.sda_pin	= 48,
	.sda_is_open_drain = 0,
	.scl_is_open_drain = 0,
...
static struct platform_device mpu3050_sensor_i2c_device = {
	.id = 8,
	.name = "i2c-gpio",
	.dev.platform_data = &mpu3050_sensor_i2c_pdata,
};

//------------------------------- dedicated based --------------------------------------
static struct mpu3050_platform_data mpu3050_pdata_msm_12c = {
	.int_config  = 0x10,
	.orientation = {  1,  0,  0,
			   0,  -1,  0,
			   0,  0, -1 },
...
static struct i2c_board_info mpu3050_sensor_i2c_bdinfo_msm[] = {

		{
			I2C_BOARD_INFO("mpu3050", GYRO_ADDR),
			.irq = MSM_GPIO_TO_INT(GYRO_IRQ),
			.platform_data = &mpu3050_pdata_msm_12c,
		},
		{
			I2C_BOARD_INFO("bma222", ACCEL_ADDR),
			.flags = I2C_CLIENT_WAKE,
...
static struct i2c_board_info __initdata akm8975c_boardinfo[] = {
	
	{
		I2C_BOARD_INFO("akm8975", COMPASS_ADDR),
		.flags = I2C_CLIENT_WAKE,
...
static struct taos_platform_data taos_i2c_data[] =
{
	{
		.power = sensor_power,
	}
...
static struct i2c_board_info taos_sensor_i2c_bdinfo[] = {
	{
		...
		.irq = MSM_GPIO_TO_INT(PROX_IRQ),
		.platform_data = &taos_i2c_data,
	},
	{
...
#if 0
//------------------------------- Fuel Gague --------------------------------------
static struct i2c_board_info fuel_gauge_i2c_bdinfo[] = {
	{
		I2C_BOARD_INFO("max17043", 0x36),
	},
};

static struct gpio_i2c_pin fuel_gauge_i2c_pin[] = {
	{
		.scl_pin	= 97,
		.sda_pin	= 98,
	},
...
static struct i2c_gpio_platform_data fuel_gauge_i2c_pdata = {
	.scl_pin	= 97,
	.sda_pin	= 98,
	.sda_is_open_drain = 0,
	.scl_is_open_drain = 0,
...
static struct platform_device fuel_gauge_i2c_device = {
	.id = 9,
	.name = "i2c-gpio",
	.dev.platform_data = &fuel_gauge_i2c_pdata,
};
#endif
static void __init vulcan_init(void)
{
	...
	int rc;
	struct vreg *vreg_ldo8;
	struct vreg *vreg_ldo10;

	/* I/O enable, for sensors, tsp */
	vreg_ldo8 = vreg_get(NULL, "gp7");
	if (!vreg_ldo8) {
		pr_err("%s: VREG L8 get failed\n", __func__);
		return;
...
void TestI2CDelay(void)
{
	udelay(10);
}

void TestI2CStart(void)
{
	TestI2CDelay();
	gpio_set_value(OUPUT_SDA, GPIO_LOW_VALUE);
}

void TestI2CStop(void)
{
	TestI2CDelay();
	gpio_set_value(OUPUT_SCL, GPIO_HIGH_VALUE);
	TestI2CDelay();
	gpio_set_value(OUPUT_SDA, GPIO_HIGH_VALUE);
	TestI2CDelay();
}

int TestI2CWriteBits(int val, int cnt)
{
	int i;

	for(i=1<<(cnt-1); i!=0; i>>=1)		// msb first. shift right
	{
		TestI2CDelay();
		gpio_set_value(OUPUT_SCL, GPIO_LOW_VALUE);
		TestI2CDelay();
		gpio_set_value(OUPUT_SDA, val&i ? GPIO_HIGH_VALUE : GPIO_LOW_VALUE);
		TestI2CDelay();
		gpio_set_value(OUPUT_SCL, GPIO_HIGH_VALUE);
	}

	// read acknoledge(ACK:0, NAK:1)
	TestI2CDelay();
	gpio_set_value(OUPUT_SCL, GPIO_LOW_VALUE);
	gpio_tlmm_config(GPIO_CFG(INPUT_SDA, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA), GPIO_CFG_ENABLE);

	
	TestI2CDelay();
	gpio_set_value(OUPUT_SCL, GPIO_HIGH_VALUE);
	i = (int) gpio_get_value(OUPUT_SDA);
	TestI2CDelay();
	gpio_set_value(OUPUT_SCL, GPIO_LOW_VALUE);
	gpio_tlmm_config(GPIO_CFG(OUPUT_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA), GPIO_CFG_ENABLE);
	gpio_set_value(OUPUT_SDA, GPIO_LOW_VALUE);

	return i;
}

int TestI2CReadBits(int* val, int cnt)
{
	int i, rd=0;
...
int TestI2CRead(int devAddr, int reg, int* val)
{
	int ack=0;

	TestI2CStart();
	ack |= TestI2CWriteBits((devAddr<<1), 8);
	ack <<= 1;
	ack |= TestI2CWriteBits(reg, 8);
	TestI2CStop();

	TestI2CStart();
	ack <<= 1;
	ack |= TestI2CWriteBits((devAddr<<1)|1, 8);
	ack <<= 1;
	ack |= TestI2CReadBits(val, 8);
	TestI2CStop();
...
int TestI2C(void)
{
	int devAddr = GYRO_ADDR;
	int val, ret, ret_val=0;

	gpio_tlmm_config(GPIO_CFG(OUPUT_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(OUPUT_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA), GPIO_CFG_ENABLE);
	...
	printk(KERN_ERR "----------- VULCAN SENSOR CHECK ---------\n");

	//gyro check
	ret = TestI2CRead(devAddr, 0, &val);
	udelay(10);
	ret = TestI2CRead(devAddr, 0, &val);
	if(val == 0x68 || val == 0x69){
		ret_val = 1;
		printk(KERN_ERR "VULCAN GYRO CHECK Success = %d\n", val);
	}
	else{
		ret_val = 0;
		printk(KERN_ERR "VULCAN GYRO CHECK Failed = %d\n", val);
	}
	
	//compass check
	udelay(10);
	ret = TestI2CRead(COMPASS_ADDR, 0, &val);
	udelay(10);
	ret = TestI2CRead(COMPASS_ADDR, 0, &val);
	if(val == 0x48)
		printk(KERN_ERR "VULCAN COMPASS CHECK Success = %d\n", val);
	else
		printk(KERN_ERR "VULCAN COMPASS CHECK Failed = %d\n", val);
	
	//accel check
	udelay(10);
	ret = TestI2CRead(ACCEL_ADDR, 0, &val);
	udelay(10);
	ret = TestI2CRead(ACCEL_ADDR, 0, &val);
	if(val == 0x03)
		printk(KERN_ERR "VULCAN ACCEL CHECK Success = %d\n", val);
	else
		printk(KERN_ERR "VULCAN ACCEL CHECK Failed = %d\n", val);

	return ret_val;

#if 0
	ret = TestI2CRead(devAddr, 0, &val);
	printk(KERN_ERR "%s: leesh gyro exist1 = ret = (%d), val = (%x)\n", __func__, ret, val);	
	if(val == 0x68 || val == 0x69) return 1;
	ret = TestI2CRead(devAddr, 0, &val);
	printk(KERN_ERR "%s: leesh gyro exist2 = ret = (%d), val = (%x)\n", __func__, ret, val);
	if(val == 0x68 || val == 0x69) return 1;
	ret = TestI2CRead(devAddr, 0, &val);
	printk(KERN_ERR "%s: leesh gyro exist3 = ret = (%d), val = (%x)\n", __func__, ret, val);
	if(val == 0x68 || val == 0x69) return 1;
	...
	for(i=0; i<0x3e; i++)
	{
		ret = TestI2CRead(devAddr, i, &val);
		printk(KERN_ERR "%s: leesh i = (%d) ret = (%d), val = (%d)\n", __func__, i, ret, val);
	}
#endif
}
#endif

int is_gyro_exist(void)
{
	return gyro_exist;
}
...
static void __init msm7x30_init(void)
{
	...
	// hw id read
	{
		...
		if(g103 == 0 && g102 == 1)//gpio-i2c
			...
			board_num = ES;
		else if(g103 == 1 && g102 == 1)//dedicate MSM i2c 
			board_num = PS;
		else
			board_num = PS;

		printk(KERN_ERR "VULCAN hwid g103 = (%d)(%d)\n", g103, g102);
	}
	// hw id read
#endif
...
#ifdef USES_TCT_USBDRIVER	//	Teddy 2012-02-22
		android_usb_pdata.product_id = 0x9017;
#else
		android_usb_pdata.product_id = 0x9026;
#endif	//	USES_TCT_USBDRIVER
	}
#endif
...
#ifdef CONFIG_MACH_MSM8X55_VULCAN 
	//INIT Camera GPIO Request
	gpio_request(21, "OV5647_RST_N"); //CAM_5MP_RST_N
	gpio_request(143, "OV5647_STANDBY"); //CAM_STANDBY
	gpio_request(19, "CAMERA_AF_EN"); //CAM_AF_EN
	gpio_request(33, "OV7690_PDN"); //CAM_PDN_SUB
	gpio_request(99,"OV5647_CAMIF_ID"); //CAMIF_ID
#endif
	...
	//------------------------------- Gyro sensor --------------------------------------
	if(get_hw_id() == HW_ID_REV_V1A)
	{
		msm8x55_gpio_i2c_pin(&mpu3050_sensor_i2c_pdata, &mpu3050_sensor_i2c_pin[0], mpu3050_sensor_i2c_bdinfo_gpio);
		i2c_register_board_info(8, mpu3050_sensor_i2c_bdinfo_gpio, ARRAY_SIZE(mpu3050_sensor_i2c_bdinfo_gpio));
		platform_device_register(&mpu3050_sensor_i2c_device);
	}
	else //if(board_num >= PT2)
	{
		unsigned int irq_pin[3]={GYRO_IRQ, ACCEL_IRQ, COMPASS_IRQ}, i;
		unsigned int irq_pin_no_gyro[2]={COMPASS_IRQ, ACCEL_IRQ};
		if(gyro_exist)
		{
			for(i=0; i<3; i++)
			{
				gpio_tlmm_config(GPIO_CFG(irq_pin[i], 0, GPIO_CFG_INPUT,
							GPIO_CFG_PULL_UP, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
				mpu3050_sensor_i2c_bdinfo_msm[i].irq = MSM_GPIO_TO_INT(irq_pin[i]);
			}
			i2c_register_board_info(0, mpu3050_sensor_i2c_bdinfo_msm, ARRAY_SIZE(mpu3050_sensor_i2c_bdinfo_msm));
		}
		else
		{
			for(i=0; i<2; i++)
			{
				gpio_tlmm_config(GPIO_CFG(irq_pin_no_gyro[i], 0, GPIO_CFG_INPUT,
							GPIO_CFG_PULL_UP, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
				akm8975c_boardinfo[i].irq = MSM_GPIO_TO_INT(irq_pin_no_gyro[i]);
			}
			i2c_register_board_info(0, akm8975c_boardinfo, ARRAY_SIZE(akm8975c_boardinfo));
#if 0
			gpio_tlmm_config(GPIO_CFG(GYRO_IRQ, 0, GPIO_CFG_INPUT,
						GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
			gpio_tlmm_config(GPIO_CFG(47, 0, GPIO_CFG_INPUT,
						GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
			gpio_tlmm_config(GPIO_CFG(48, 0, GPIO_CFG_INPUT,
						GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
			gpio_tlmm_config(GPIO_CFG(96, 0, GPIO_CFG_INPUT,
						GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
#endif
		}
	}
...
#if 1
	//------------------------------- proximity sensor --------------------------------------
	msm8x55_gpio_i2c_pin(&taos_sensor_i2c_pdata, &taos_sensor_i2c_pin[0], taos_sensor_i2c_bdinfo);
	i2c_register_board_info(9, taos_sensor_i2c_bdinfo, ARRAY_SIZE(taos_sensor_i2c_bdinfo));
	platform_device_register(&taos_sensor_i2c_device);
#endif
#if 0
	//------------------------------- Fuel Gauge -------------------------
	msm8x55_gpio_i2c_pin(&fuel_gauge_i2c_pdata, &fuel_gauge_i2c_pin[0], fuel_gauge_i2c_bdinfo);
	i2c_register_board_info(9, fuel_gauge_i2c_bdinfo, ARRAY_SIZE(fuel_gauge_i2c_bdinfo));
	platform_device_register(&fuel_gauge_i2c_device);
#endif
...
MACHINE_START(MSM8X55_VULCAN, "TCT MSM8X55 VULCAN")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io  = MSM_DEBUG_UART_PHYS,
	.io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
