...
/* 8000 profile also works for 48k */
static struct adie_codec_action_unit imic_ffa_48KHz_osr256_actions[] = AMIC_PRI_MONO_8000_OSR_256;
...
//dana_120228_loopback_handset_mic==>>

static struct adie_codec_action_unit imic_loopback_actions[] = AMIC_HANDSET_LOOPBACK;

static struct adie_codec_hwsetting_entry imic_loopback_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = imic_loopback_actions,
		.action_sz = ARRAY_SIZE(imic_loopback_actions),
	}
};


static struct adie_codec_dev_profile imic_loopback_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = imic_loopback_settings,
	.setting_sz = ARRAY_SIZE(imic_loopback_settings),
};

static struct snddev_icodec_data snddev_imic_loopback_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "handset_loopback_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_MIC,
	.profile = &imic_loopback_profile,
	.channel_mode = 1,
	.pmctl_id = imic_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(imic_pmctl_id),
	.default_sample_rate = 48000,
...
static struct platform_device msm_imic_loopback_device = {
	.name = "snddev_icodec",
	.id = 28,
	.dev = { .platform_data = &snddev_imic_loopback_data },
};
//dana_120228_loopback_handset_mic <<==

//dana   submic loopback ==>>
static struct adie_codec_action_unit submic_ffa_48KHz_osr256_actions[] = AMIC1_SUBMIC_TX_LOOPBACK;

static struct adie_codec_hwsetting_entry submic_ffa_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = submic_ffa_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(submic_ffa_48KHz_osr256_actions),
	}
};


static struct adie_codec_dev_profile submic_ffa_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = submic_ffa_settings,
	.setting_sz = ARRAY_SIZE(submic_ffa_settings),
};

static struct snddev_icodec_data snddev_submic_ffa_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "submic_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_MIC,
	.profile = &submic_ffa_profile,
	.channel_mode = 1,
	.pmctl_id = imic_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(imic_pmctl_id),
	.default_sample_rate = 48000,
...
static struct platform_device msm_submic_ffa_device = {
	.name = "snddev_icodec",
	.id = 29,
	.dev = { .platform_data = &snddev_submic_ffa_data },
};


// dana_120228_loopback     <<==
...
//dana_120228_loopback     ==>>
static struct adie_codec_action_unit iheadset_mic_loopback_tx_actions[] =
	AMIC1_HEADSET_TX_LOOPBACK;

static struct adie_codec_hwsetting_entry iheadset_mic_loopback_tx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = iheadset_mic_loopback_tx_actions,
		.action_sz = ARRAY_SIZE(iheadset_mic_loopback_tx_actions),
	}
};

static struct adie_codec_dev_profile iheadset_loopback_mic_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = iheadset_mic_loopback_tx_settings,
	.setting_sz = ARRAY_SIZE(iheadset_mic_loopback_tx_settings),
};

static struct snddev_icodec_data snddev_loopback_headset_mic_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "headset_loopback_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HEADSET_MIC,
	.profile = &iheadset_loopback_mic_profile,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_loopback_headset_mic_device = {
	.name = "snddev_icodec",
	.id = 33,
	.dev = { .platform_data = &snddev_loopback_headset_mic_data },
};
...
/*
Headset Rx volume Max : -1200 ->-1000 > 700
                        Min : -2700 -> -3000  > 800
...
//dana_120228_loopback     ==>>
static struct snddev_icodec_data snddev_speaker_loopback = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
...
static struct platform_device msm_speaker_loopback_tx_device = {
	.name = "snddev_icodec",
	.id = 27,
	.dev = { .platform_data = &snddev_speaker_loopback },
};
...
//morris
	...
	&msm_loopback_headset_mic_device,
	&msm_imic_loopback_device,
	&msm_speaker_loopback_tx_device,
	&msm_submic_ffa_device,
};
