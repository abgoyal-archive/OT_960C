...
#if 0	// by sinclair.lee 20120424 according to Qualcomm CR328249 (gpu crash)
...
int kgsl_pwrctrl_init(struct kgsl_device *device)
{
	...
	pwr->idle_needed = pdata_pwr->idle_needed;	// by sinclair.lee 20120424 according to Qualcomm CR328249 (gpu crash)
