...
/*
 * change the order to match with torch_flash.c by shane.choi
 */
	...
	unsigned led_state)
{
	...
	case MSM_CAMERA_LED_LOW:
		rc = torch_flash_control(MSM_CAM_CUSTOM_FLASH_LOW);
		break;

//	Teddy 2012-06-19		
	case MSM_CAMERA_LED_MIDDLE:
		rc = torch_flash_control(MSM_CAM_CUSTOM_FLASH_MIDDLE);
		break;
//	End of teddy
	...
	case MSM_CAMERA_LED_HIGH:
		...
		break;
	/* add MSM_CAMERA_LED_MAX for ledtorch by shane.choi */
	case MSM_CAMERA_LED_MAX:
...
#elif defined(CONFIG_LEDS_PMIC8058) //#if defined CONFIG_LEDS_PMIC8058
	int idx;
