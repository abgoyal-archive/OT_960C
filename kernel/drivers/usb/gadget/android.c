...
const char serial_number_temp[MAX_STR_LEN] = "1234567890ABCDEF";
...
#ifdef DEFAULT_SERIAL_NUMBER	//	Teddy 2012-05-01
	if(!msm_hsusb_check_serial() && pdata->serial_number[0] != '\0')
	{
		pr_info("%s : check = FALSE\n",__func__);
		strings_dev[STRING_SERIAL_IDX].s = serial_number_temp;
	}
#endif	//	DEFAULT_SERIAL_NUMBER
