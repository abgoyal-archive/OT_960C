...
#define YPR_DATA_SIZE		14
#define RWBUF_SIZE			16

#define ACC_DATA_FLAG		0
#define MAG_DATA_FLAG		1
#define ORI_DATA_FLAG		2
#define PROX_DATA_FLAG		3
#define LIGHT_DATA_FLAG	4
#define AKM_NUM_SENSORS	5

#define ACC_DATA_READY		(1<<(ACC_DATA_FLAG))
#define MAG_DATA_READY	(1<<(MAG_DATA_FLAG))
#define ORI_DATA_READY		(1<<(ORI_DATA_FLAG))
#define LIGHT_DATA_READY	(1<<(LIGHT_DATA_FLAG))
#define PROX_DATA_READY	(1<<(PROX_DATA_FLAG))
