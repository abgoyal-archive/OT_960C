...
#define TAOS_IOCTL_PROX_ON_EXEC	_IO(TAOS_IOCTL_MAGIC, 17)
#define TAOS_IOCTL_PROX_OFF_EXEC	_IO(TAOS_IOCTL_MAGIC, 18)
#define TAOS_IOCTL_PROX_GET_DATA	_IO(TAOS_IOCTL_MAGIC, 19)

#define TAOS_IOCTL_ALS_GET_DATA	_IO(TAOS_IOCTL_MAGIC, 20)

#define TAOS_IOCTL_ALS_ON_EXEC		_IO(TAOS_IOCTL_MAGIC, 21)
#define TAOS_IOCTL_ALS_OFF_EXEC		_IO(TAOS_IOCTL_MAGIC, 22)

#define TAOS_IOCTL_GET_LCD_STATUS		_IO(TAOS_IOCTL_MAGIC, 23)
